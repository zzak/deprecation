...
class ZomgDeprecation
  ...
  class DeprecatedObjectProxy < DeprecationProxy
    def initialize(object, message, deprecator = ZomgDeprecation.instance)
      @object = object
      @message = message
  ...
  class DeprecatedInstanceVariableProxy < DeprecationProxy
    def initialize(instance, method, var = "@#{method}", deprecator = ZomgDeprecation.instance)
      @instance = instance
      @method = method
      @var = var
      @deprecator = deprecator
  ...
  class DeprecatedConstantProxy < DeprecationProxy
    def initialize(old_const, new_const, deprecator = ZomgDeprecation.instance)
      @old_const = old_const
      @new_const = new_const
      @deprecator = deprecator
    end
